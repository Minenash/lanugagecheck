...
public class WDownloadedLanguageList extends WWidget {
    ...
    public WDownloadedLanguageList(LanguageOptionsScreenDefinition mainScreen) {
        this.mainScreen = mainScreen;

        entries.add(Languages.languages.get("English").get(1));
        entries.add(Languages.languages.get("Spanish").get(0));
        entries.add(Languages.languages.get("Ukrainian").get(0));
